...
export default function OfflinePage() {
  return (
    <main className="surface-light site-shell mx-auto my-0 max-w-[1096px] rounded-none bg-[var(--content-bg)] pb-20 pt-16 backdrop-blur-sm md:my-4 md:rounded-[12px] md:border md:border-[var(--content-border)] md:pt-20">
