export default function AuthorDocumentLoading() {
  return (
    <main className="site-shell pb-20 pt-[154px]">
      <div className="grid gap-8 animate-pulse">
        <div className="-mt-8 border-b border-[rgba(42,36,25,0.08)] bg-[rgba(250,248,245,0.95)] py-3">
          <div className="flex w-full items-center justify-between">
            <div className="h-8 w-24 rounded-[4px] bg-[rgba(42,36,25,0.08)]" />
            <div className="flex items-center gap-3">
              <div className="h-6 w-20 rounded-[999px] bg-[rgba(42,36,25,0.08)]" />
              <div className="h-9 w-28 rounded-[4px] bg-[rgba(42,36,25,0.08)]" />
            </div>
          </div>
        </div>
