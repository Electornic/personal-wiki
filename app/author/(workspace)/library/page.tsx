...
import { MyLibraryDiscoveryControls } from "@/app/author/(workspace)/library/_components/my-library-discovery-controls";
...
function buildPageHref(
  ...
  return query ? `/author/library?${query}` : "/author/library";
}
