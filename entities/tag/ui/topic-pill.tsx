...
function TopicPillInner({ label, interactive }: { label: string; interactive: boolean }) {
  return (
    <span
      className={`inline-flex h-[26px] items-center justify-center rounded-full bg-[rgba(232,227,219,0.6)] px-[13px] text-[12px] leading-4 font-normal text-[#2a2419] transition-colors ${
