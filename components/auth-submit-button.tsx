...
export function AuthSubmitButton({
  ...
  return (
    <button
      className="mt-4 inline-flex h-10 w-full items-center justify-center gap-2 rounded-[4px] bg-[var(--accent)] text-[14px] leading-5 font-medium text-[var(--accent-text)] transition-all duration-200 hover:-translate-y-px hover:bg-[#3a3328] hover:shadow-[0_10px_24px_rgba(42,36,25,0.12)] disabled:translate-y-0 disabled:bg-[#8f8778] disabled:shadow-none"
      type="submit"
      disabled={pending}
    >
