  ...
  return (
    <>
      <button
        ...
        className="mt-3 inline-flex items-center gap-1.5 rounded-[4px] px-2 py-1 text-[12px] leading-4 font-medium text-[var(--foreground)] transition hover:bg-[rgba(232,227,219,0.2)]"
      >
        <svg
          aria-hidden="true"
          className="h-4 w-4"
